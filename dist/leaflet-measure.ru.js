! function(e) {
  ...
  e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Измерение расстояний и площади">Измерение</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Измерение расстояний и площади</h3> <ul class=tasks> <a href=# class="js-start start">Создать новое измерение</a> </ul> </div> <div class=js-measuringprompt> <h3>Измерение расстояний и площади</h3> <p class=js-starthelp>Для начала измерения добавьте точку на карту</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Отменить</a></li> <li><a href=# class="js-finish finish">Закончить измерение</a></li> </ul> </div> </div> '
}, function(e, t, r) {
  e.exports = '<div class=group> <p class="lastpoint heading">Последняя точка</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Расстояние</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Область</span> {{ model.areaDisplay }}</p> </div> <% } %> '
}, function(e, t, r) {
  ...
  e.exports = '<h3>Линейное измерение</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Сфокусироваться на данной линии</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Удалить</a></li> </ul> '
}, function(e, t, r) {
  e.exports = '<h3>Измерение области</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Периметр</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Сфокусироваться на данной области</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Удалить</a></li> </ul> '
}]);